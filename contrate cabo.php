...
<section class="contrate bloco scrollspy" id="contrate">
	<div class="row container">
		<div class="col s12 center">
			<h2 class="titulo light">Contrate</h2>
		</div>

			<div class="col s12 m12 l8 offset-l2 ">
				<div class="formulario white center">
				<h4>Planos</h4>
				<p class="light"> Entraremos em contato o mais rápido possível!</p>

				<form action="contrate-cabo.php" method="post" class="input-field">
					...
					<div class="input-field">
    					<select type="text" name="contcabo" id="contcabo" >
      							<option value="" disabled selected>Escolha seu Plano</option>
        						<option value="Cabo - 8mb/R$ 69,99">8 Megas por R$69,99</option>
        						<option value="Cabo - 10mb/R$ 79,99">10 Megas por R$79,99  </option>
        						<option value="Cabo - 12mb/R$ 89,99">12 Megas por R$89,99 </option>
        						<option value="Cabo - 15mb/R$ 99,99">15 Megas por R$99,99 </option>
        						<option value="Cabo - 20mb/R$ 109,99">20 Megas por R$109,99 </option>
        						<option value="Cabo - 25mb/R$ 119,99">25 Megas por R$119,99 </option>	
    					</select>
  					</div>
