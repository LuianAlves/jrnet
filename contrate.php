	...
	<div class="row container">
		<div class="col s12 center">
			...
			<div class="col s12 m12 l8 offset-l2 ">
				...
				<form action="contrate-fibra.php" method="post" class="input-field">
					...
					<div class="input-field">
    					<select type="text" name="contfibra" id="contfibra" >
      							<option value="" disabled selected>Planos</option>
        						<option value="fibra 10mbs">10 Megas por R$69,90</option>
        						<option value="fibra 15mbs">15 Megas por R$79,90  </option>
        						<option value="fibra 20mbs">20 Megas por R$89,90 </option>
        						<option value="fibra 30mbs">30 Megas por R$99,90  </option>
        						<option value="fibra Acima de 30mb">Acima de 30MBS</option>	
    					</select>
  					</div>
