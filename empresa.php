...
<section class="sobre bloco scrollspy" id=empresa>
	<div class="row container">
		<div class="col s12 center">
			<h2 class="titulo light">Empresa</h2>
		</div>

		<div class="col s12 l6">
			<p class="light">
			A JRNET está a mais de 8 anos na área trazendo um novo conceito tanto em navegação casual quanto profissional, conta com uma equipe profissional altamente qualificada com experiência no mercado. <br>Localizada no Grajaú, temos cobertura por quase toda região, entre em contato para saber se estamos disponível. <br><br> </p> 
		</div>
