	...
	<div class="row container">
		<div class="col s12 center">
			...
			<div class="col s12 m12 l8 offset-l2 ">
				...
				<h4>Planos Econômicos</h4>
				<p class="light"> Entraremos em contato o mais rápido possível!</p>

				<form action="contrate-eco.php" method="post" class="input-field">
					...
					<div class="input-field">
    					<select type="text" name="conteco" id="conteco" >
      							<option value="" disabled selected>Planos</option>
        						<option value="Economico - 3mb/R$42,80">3 Megas por R$42,80</option>
        						<option value="Economico - 4mb/R$52,80">4 Megas por R$52,80  </option>
        						<option value="Economico - 5mb/R$59,99">5 Megas por R$59,99 </option>	
    					</select>
  					</div>
